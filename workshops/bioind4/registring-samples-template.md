...
Assuming you are already logged in click the Create button from the top-navigation bar and from the drop-down menu select “datafile” and a new page will open up: Upload datafile(3.Samples_A.Niger.xlsx)
...
Choose the existing assay to which the Sample belongs
...
Click “Confirm” and the samples will be assigned to your Project.
...
<!-- Commented [2]: is this still valid? -->
