...
***Click “File to Upload”:*** Samples_A.Niger.xlsx and then `Hit the “Create” button.
...
Once Step 4 is completed click update. Your Sample Type can now be used to generate Samples.
...
From here you can now create your samples using the Create sample button
...
Assign the Sample to the project to which it belongs:
